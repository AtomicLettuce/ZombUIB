...
function createVRHUD() {
	let VRHUDAmmo = document.createElement('a-text');
	VRHUDAmmo.setAttribute('value', '');
	VRHUDAmmo.setAttribute('id', 'VRHUDAmmo');
	VRHUDAmmo.setAttribute('position', '0 -0.2 -0.5');
	VRHUDAmmo.setAttribute('scale', '0.5 0.5 0.5');
	VRHUDAmmo.setAttribute('align', 'center');
	VRHUDAmmo.setAttribute('color', '#ff0000');
	VRHUDAmmo.setAttribute('visible', 'false');

	let VRHUDHP = document.createElement('a-text');
	VRHUDHP.setAttribute('value', '100 HP');
	VRHUDHP.setAttribute('id', 'VRHUDHP');
	VRHUDHP.setAttribute('position', '0 0 -0.5');
	VRHUDHP.setAttribute('scale', '0.5 0.5 0.5');
	VRHUDHP.setAttribute('align', 'center');
	VRHUDHP.setAttribute('color', '#ff0000');
	VRHUDHP.setAttribute('visible', 'false');

	let VRHUDRound = document.createElement('a-text');
	VRHUDRound.setAttribute('value', '');
	VRHUDRound.setAttribute('id', 'VRHUDRound');
	VRHUDRound.setAttribute('position', '0 0.2 -0.5');
	VRHUDRound.setAttribute('scale', '0.5 0.5 0.5');
	VRHUDRound.setAttribute('align', 'center');
	VRHUDRound.setAttribute('color', '#ff0000');
	VRHUDRound.setAttribute('visible', 'false');
	myCamera.appendChild(VRHUDHP);
	myCamera.appendChild(VRHUDAmmo);
	myCamera.appendChild(VRHUDRound);
}

function VRtoggleHUD() {
	VRHUDRound.setAttribute('visible', !VRHUDRound.getAttribute('visible'));
	VRHUDHP.setAttribute('visible', !VRHUDHP.getAttribute('visible'));
	VRHUDAmmo.setAttribute('visible', !VRHUDAmmo.getAttribute('visible'));
}
...
function startGame() {
	...
	if (inVR) {
		...
		lh.addEventListener('triggerdown', () => {
			VRtoggleHUD();
		});
